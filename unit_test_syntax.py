...
class TestUnittestMethods(unittest.TestCase):
    ...
    def testNotAlmostEqual(self):
        """
            ...
            Сравниевает два аргумента с округлением, можно задать
            это округление. Вызывает ошибку, если занчения равны.
        """
    ...
    def testAlmostEqual(self):
        """
            ...
            Сравнивается два аргумента с округление, можно задать
